      ...
      <div className="impact-container">
        ...
        <div className="impact-left-side">
          ...
          <p className="impact-sub">
            Sem o GiroPátio centralizando e automatizando o processo, o custo de não ter o sistema cobra seu preço todos os dias.
          </p>
        ...
        <div className="impact-right-side">
          <div className="mockup-wrapper">
            ...
            <img 
              src={imagemImpacto} 
              alt="Mockup do sistema GiroPátio e gestor analisando métricas de leads" 
